...
(function (Etymology) {
    ...
    Etymology.templPOS = ['adj', 'adv', 'con', 'det', 'interj', 'noun', 'num', 'part', 'postp', 'prep', 'pron', 'proper noun', 'verb'];
    Etymology.RELATIONS = [
...
(function (Etymology) {
                ...
                for (let lvl2 = toplvl.sections()[0]; lvl2; lvl2 = lvl2.nextSibling()) {
                    ...
                    if (/Etymology \d+/.test(lvl2.title())) {
                        ...
                        for (let lvl3 = lvl2.sections()[0]; lvl3; lvl3 = lvl3.nextSibling()) {
                            if (Etymology.PARTS_OF_SPEECH.indexOf(lvl3.title().toLowerCase()) >= 0) {
                    ...
                    else if (Etymology.PARTS_OF_SPEECH.indexOf(lvl2.title().toLowerCase()) >= 0) {
    ...
    Etymology.fetchEtyEntry = fetchEtyEntry;
    ...
    Etymology.parseDictEntry = parseDictEntry;
})(Etymology || (Etymology = {}));
